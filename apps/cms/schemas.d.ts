...
export interface ApiProjectProject extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    challengesAndSolutions: TextAttribute;
    resultsAchieved: TextAttribute;
    testimonial: TextAttribute;
    callToAction: StringAttribute;
    projectType: StringAttribute;
    images: StringAttribute;
    blogPostLink: StringAttribute;
    media: MediaAttribute;
    mainImage: MediaAttribute;
    technical_skills: RelationAttribute<
      'api::project.project',
      'oneToMany',
...
export interface ApiSkillCategorySkillCategory extends CollectionTypeSchema {
  info: {
...
export interface ApiTechnicalSkillTechnicalSkill extends CollectionTypeSchema {
  info: {
  ...
  attributes: {
    ...
    rating: IntegerAttribute &
      ...
      DefaultTo<1>;
    hotness: IntegerAttribute &
      SetMinMax<{
        min: 1;
        max: 10;
      }> &
      DefaultTo<1>;
    skill_category: RelationAttribute<
      'api::technical-skill.technical-skill',
      'manyToOne',
      'api::skill-category.skill-category'
    >;
