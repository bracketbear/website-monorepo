...
export function GroupControl({
  ...
  // Create accordion items for the group controls
  const accordionItems = [
    {
      ...
      content: (
        <div className="space-y-2">
          {safeValue.length === 0 && (
            <div className="text-xs text-white/40 italic">No items</div>
          )}
  ...
  return (
    <div className="group-control">
      <Accordion items={accordionItems} variant="minimal" className="w-full" />
    </div>
  );
}
