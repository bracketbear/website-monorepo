  ...
  return (
    ...
    >
      ...
      {stats.map((stat, index) => (
        ...
        >
          <h4 className="font-heading mb-1 text-sm font-black tracking-widest text-white/70 uppercase">
            {stat.label}
          </h4>
          <div className="font-heading mt-2 text-2xl font-bold tracking-tight text-white">
            {stat.value}
          </div>
        </div>
      ))}
